...
<title>芯媒科技后台管理系统</title>
<meta name="Keywords" content="芯媒科技"/>
<meta name="Description" content="芯媒科技后台管理系统"/> 
<!-- bootstrap - css -->
...
<body>
    ...
    <header class="navbar navbar-default" id="bjui-header">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://www.lxinet.com" target="_blank"><img src="../res/images/lxinetlogo.png"></a>
        </div>
                ...
                <div class="page unitBox">
                    <div class="bjui-pageHeader" style="background:#FFF;">
                        <div style="padding: 0 5px;">
                            ...
                            <h4 style="margin-bottom:20px;">欢迎使用芯媒科技分销系统</h4>
                            	<div class="col-md-6">
                            		<h5></h5>
                                    <h5></h5>
                                    <h5></h5>
