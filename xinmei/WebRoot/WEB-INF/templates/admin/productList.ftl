    ...
    <table data-toggle="tablefixed" data-width="100%" data-layout-h="0" data-nowrap="true">
		...
		<tbody>
            ...
            <tr>
                ...
                <td>
                	<a href="kamiList?pid=${product.id}" class="btn btn-green" data-toggle="dialog" data-width="1000" data-height="600" data-id="lookKami" data-mask="true">查看</a>
                	<a href="kamiAdd?pid=${product.id}" class="btn btn-green" data-toggle="dialog" data-width="800" data-height="500" data-id="addKami" data-mask="true">添加</a>
                	<a href="uploadKamiPage?pid=${product.id}" class="btn btn-green" data-toggle="dialog" data-width="800" data-height="500" data-id="uploadKami" data-mask="true">导入</a>
                    ...
                    <a href="productDelete?id=${product.id}" class="btn btn-red" data-toggle="doajax" data-confirm-msg="确定要删除该产品吗？删除之后，该产品的所有分销码将被清空！！！">删</a>
                </td>
            </tr>
		</#list>
		</tbody>
