package com.lxinet.fenxiao.pay.alipay;
...
import com.lxinet.fenxiao.pay.httpClient.HttpProtocolHandler;
import com.lxinet.fenxiao.pay.httpClient.HttpRequest;
import com.lxinet.fenxiao.pay.httpClient.HttpResponse;
import com.lxinet.fenxiao.pay.httpClient.HttpResultType;
...
public class AlipaySubmit {
     ...
     * @throws Exception
     */
    public static String buildRequest(String strParaFileName, String strFilePath,Map<String, String> sParaTemp,String alipayKey) throws Exception {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp,alipayKey);
