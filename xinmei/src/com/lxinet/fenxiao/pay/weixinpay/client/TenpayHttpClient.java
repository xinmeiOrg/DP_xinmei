package com.lxinet.fenxiao.pay.weixinpay.client;

import com.lxinet.fenxiao.pay.weixinpay.util.HttpClientUtil;
...
public class TenpayHttpClient {
	...
	protected void callHttp() throws IOException {
		...
		if("POST".equals(this.method.toUpperCase())) {
			...
			String queryString = new String(this.reqContent.toString().getBytes(), "ISO8859-1");
	...
	public boolean callHttpPost(String url, String postdata) {
		...
		byte[] postData;
		try {
			postData = (new String(postdata.getBytes(), "ISO8859-1")).getBytes("ISO8859-1");
			this.httpPostMethod(url, postData);
			flag = true;
